...
(1, 'John', 'Doe', 'visitante', 'john.doe@example.com', 'password1'),
(2, 'Jane', 'Smith', 'visitante', 'jane.smith@example.com', 'password2'),
(3, 'Alice', 'Brown', 'visitante', 'alice.brown@example.com', 'password3'),
(4, 'Bob', 'Johnson', 'visitante', 'bob.johnson@example.com', 'password4'),
(5, 'Charlie', 'Davis', 'visitante', 'charlie.davis@example.com', 'password5'),
(6, 'Eve', 'Martinez', 'admin', 'eve.martinez@example.com', 'password6'),
(7, 'Frank', 'Clark', 'visitante', 'frank.clark@example.com', 'password7'),
(8, 'Grace', 'Rodriguez', 'visitante', 'grace.rodriguez@example.com', 'password8'),
(9, 'Henry', 'Lewis', 'visitante', 'henry.lewis@example.com', 'password9'),
(10, 'Ivy', 'Walker', 'visitante', 'ivy.walker@example.com', 'password10'),
(11, 'Dandi', 'F', 'visitante', 'asd@asd', '123'),
(12, 'Dandi', 'F', 'visitante', 'asd@asd', '23');
...
--
ALTER TABLE `detalle_pedido`
  MODIFY `PK_detpedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `pedido`
--
ALTER TABLE `pedido`
  MODIFY `PK_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
